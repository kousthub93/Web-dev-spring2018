defmodule Tracker3Web.TaskControllerTest do
  use Tracker3Web.ConnCase

  alias Tracker3.Tasks
  alias Tracker3.Tasks.Task

  @create_attrs %{assigned_to: "some assigned_to", body: "some body", done: true, time_spent: 42, title: "some title"}
  @update_attrs %{assigned_to: "some updated assigned_to", body: "some updated body", done: false, time_spent: 43, title: "some updated title"}
  @invalid_attrs %{assigned_to: nil, body: nil, done: nil, time_spent: nil, title: nil}
